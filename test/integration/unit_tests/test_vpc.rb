...
test_tf = Rhcl.parse(File.open('test/fixtures/wrapper/test.tf'))
vpc_name = test_tf['module']['vpc']['name']
user_tag = test_tf['module']['vpc']['tags']['Owner']
environment_tag = test_tf['module']['vpc']['tags']['Environment']
